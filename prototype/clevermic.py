...
while True:
    ...
    try:
        ...
        print("You say: "+r.recognize_google(audio).split()[len(r.recognize_google(audio).split())-1])
        text=r.recognize_google(audio).split()[len(r.recognize_google(audio).split())-1]
    except:
